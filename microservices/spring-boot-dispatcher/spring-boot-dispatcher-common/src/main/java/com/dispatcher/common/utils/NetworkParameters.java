...
import io.zestic.coin.bouncycastle.util.encoders.Hex;
 ...
 * of a BitCoin chain.
 * <p>
 * Currently there are only two, the production chain and the test chain. But in
 * future as BitCoin evolves there may be more. You can create your own as long
 * as they don't conflict.
 */
public class NetworkParameters implements Serializable {

    /**
     * The protocol version this library implements. A value of 31800 means
     * 0.3.18.00.
     */
     ...
     * and production BitCoin networks use 2 weeks (1209600 seconds).
     */
