...
import com.dispatcher.service.odoo.api.Field.FieldType;
import com.dispatcher.service.odoo.api.helpers.FilterHelper;
...
public class ObjectAdapter {
	...
	private final com.dispatcher.service.odoo.api.FieldCollection allFields;
	private final com.dispatcher.service.odoo.api.Version serverVersion;
	...
	ObjectAdapter(OdooCommand command, String modelName, com.dispatcher.service.odoo.api.Version serverVersion)
	...
	synchronized void validateModelExists() throws OdooApiException, XmlRpcException {
		...
		if (objectNameCache.indexOf(modelName) < 0) {
			...
			if (!isUserPortal()) {
				...
				com.dispatcher.service.odoo.api.Response response = command.searchObject("ir.model", new Object[] {});
	...
	private static void refreshSignalCache(OdooCommand command) throws OdooApiException {
		signalCache.clear();
		try {
			com.dispatcher.service.odoo.api.Response response = command.searchObject("workflow.transition", new Object[] {});
	 ...
	 * @throws OdooApiException
	 */
	public com.dispatcher.service.odoo.api.Row getNewRow(com.dispatcher.service.odoo.api.FieldCollection fields) throws OdooApiException {
		return new com.dispatcher.service.odoo.api.Row(new HashMap<String, Object>(), fields);
	}
	 ...
	 * @throws OdooApiException
	 */
	public com.dispatcher.service.odoo.api.Row getNewRow(String[] fields) throws XmlRpcException, OdooApiException {
	...
	public RowCollection readObject(Object[] ids, String[] fields) throws XmlRpcException, OdooApiException {
		...
		com.dispatcher.service.odoo.api.FieldCollection fieldCol = new com.dispatcher.service.odoo.api.FieldCollection();
	 ...
	 * @throws XmlRpcException
	 */
	public com.dispatcher.service.odoo.api.FieldCollection getFields() throws XmlRpcException {
	...
	public String[] getFieldNames() throws XmlRpcException {
		com.dispatcher.service.odoo.api.FieldCollection fields = getFields(new String[] {});
	 ...
	 */
	@SuppressWarnings("unchecked")
	public com.dispatcher.service.odoo.api.FieldCollection getFields(String[] filterFields) throws XmlRpcException {
		com.dispatcher.service.odoo.api.FieldCollection collection = new com.dispatcher.service.odoo.api.FieldCollection();
	 ...
	 * @throws OdooApiException
	 */
	public Object[] validateFilters(final com.dispatcher.service.odoo.api.FilterCollection filters) throws OdooApiException {
	...
	private Object[] fixImportData(com.dispatcher.service.odoo.api.Row inputRow) throws OdooApiException, XmlRpcException {
		...
		for (int i = 0; i < inputRow.getFields().size(); i++) {
			...
			case SELECTION:
				...
				for (com.dispatcher.service.odoo.api.SelectionOption option : fld.getSelectionOptions()) {
			...
			case MANY2MANY:
				...
				if (!modelNameCache.containsKey(fld.getRelation())) {
					...
					Object[] ids = new Object[] {};
					com.dispatcher.service.odoo.api.Response response = command.searchObject(fld.getRelation(), new Object[] {});
					if (response.isSuccessful()) {
						ids = response.getResponseObjectAsArray();
	...
	private String[] getFieldListForImport(com.dispatcher.service.odoo.api.FieldCollection currentFields) {
	...
	public boolean importData(RowCollection rows) throws OdooApiException, XmlRpcException {
		...
		for (int i = 0; i < rows.size(); i++) {
			com.dispatcher.service.odoo.api.Row row = rows.get(i);
	 ...
	 * @throws OdooApiException
	 */
	public int getObjectCount(com.dispatcher.service.odoo.api.FilterCollection filter) throws XmlRpcException, OdooApiException {
		Integer count = 0;
		Object[] preparedFilters = validateFilters(filter);

		com.dispatcher.service.odoo.api.Response response = command.searchObject(modelName, preparedFilters, -1, -1, null, true);
		if (response.isSuccessful()) {
	 ...
	 * @throws OdooApiException
	 */
	public RowCollection searchAndReadObject(com.dispatcher.service.odoo.api.FilterCollection filter, String[] fields)
	 ...
	 * @throws OdooApiException
	 */
	public RowCollection searchAndReadObject(final com.dispatcher.service.odoo.api.FilterCollection filter, final String[] fields, int offset,
                                             int limit, String order) throws XmlRpcException, OdooApiException {

		String[] fieldArray = fields == null ? new String[] {} : fields;
		Object[] preparedFilters = validateFilters(filter);
		Object[] idList = null;
		com.dispatcher.service.odoo.api.Response response = command.searchObject(modelName, preparedFilters, offset, limit, order, false);
		if (response.isSuccessful()) {
	 ...
	 * @throws XmlRpcException
	 */
	public boolean writeObject(final com.dispatcher.service.odoo.api.Row row, boolean changesOnly) throws OdooApiException {
	...
	private Map<String, Object> collectValues(final com.dispatcher.service.odoo.api.Row row, boolean changesOnly) {
		Map<String, Object> valueList = new HashMap<>();
		com.dispatcher.service.odoo.api.FieldCollection fields;
		if (changesOnly) {
	 ...
	 * @throws XmlRpcException
	 */
	public void createObject(final com.dispatcher.service.odoo.api.Row row) throws OdooApiException, XmlRpcException {
	 ...
	 * @throws OdooApiException
	 */
	public com.dispatcher.service.odoo.api.FieldCollection callFieldsFunction(String functionName, Object[] parameters)
			throws XmlRpcException, OdooApiException {
		com.dispatcher.service.odoo.api.Response response = command.callObjectFunction(modelName, functionName, parameters);

		return callFieldsFunction(response);
	}

	@SuppressWarnings("unchecked")
	private com.dispatcher.service.odoo.api.FieldCollection callFieldsFunction(com.dispatcher.service.odoo.api.Response response) {
		if (!response.isSuccessful()) {
			return new com.dispatcher.service.odoo.api.FieldCollection();
		}
	 ...
	 * @throws OdooApiException
	 */
	public RowCollection callFunction(String functionName, Object[] parameters, com.dispatcher.service.odoo.api.FieldCollection fieldCol)
			throws OdooApiException {
		com.dispatcher.service.odoo.api.Response response = command.callObjectFunction(modelName, functionName, parameters);
		...
		com.dispatcher.service.odoo.api.FieldCollection fieldCollection = fieldCol != null ? fieldCol : callFieldsFunction(response);
	 ...
	 * @throws OdooApiException
	 */
	public void executeWorkflow(com.dispatcher.service.odoo.api.Row row, String signal) throws XmlRpcException, OdooApiException {
		// Sanity check
	 ...
	 * @throws XmlRpcException
	 */
	public boolean unlinkObject(com.dispatcher.service.odoo.api.Row row) throws XmlRpcException {
