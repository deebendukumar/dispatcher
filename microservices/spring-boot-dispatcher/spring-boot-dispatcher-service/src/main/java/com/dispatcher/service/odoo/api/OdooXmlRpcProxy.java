...
public class OdooXmlRpcProxy extends XmlRpcClient {
	 ...
	 */
	public static com.dispatcher.service.odoo.api.Version getServerVersion(RPCProtocol protocol, String host, int port) throws XmlRpcException {
		OdooXmlRpcProxy client = new OdooXmlRpcProxy(protocol, host, port, RPCServices.RPC_DATABASE);

		return new com.dispatcher.service.odoo.api.Version(client.execute("server_version", new Object[] {}).toString());
	}
}
