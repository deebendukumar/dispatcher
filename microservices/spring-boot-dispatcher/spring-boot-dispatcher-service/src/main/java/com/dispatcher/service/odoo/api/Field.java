 ...
 */
public class Field implements Auditable {
     ...
     * @return
     */
    public ArrayList<com.dispatcher.service.odoo.api.SelectionOption> getSelectionOptions() {
        if (this.getType() != FieldType.SELECTION)
            return null;

        ArrayList<com.dispatcher.service.odoo.api.SelectionOption> options = new ArrayList<com.dispatcher.service.odoo.api.SelectionOption>();
        Object values = getFieldProperty("selection");
        if (values instanceof Object[])
            for (Object val : (Object[]) values) {
                Object[] multiVal = (Object[]) val;
                options.add(new com.dispatcher.service.odoo.api.SelectionOption(multiVal[0].toString(), multiVal[1].toString()));
            }
        return options;
    }
