...
public class OdooCommand {
    ...
    private final com.dispatcher.service.odoo.api.Session session;
     ...
     */
    public OdooCommand(com.dispatcher.service.odoo.api.Session session) {
     ...
     */
    public com.dispatcher.service.odoo.api.Response searchObject(String objectName, Object[] filter) throws XmlRpcException {
        return (com.dispatcher.service.odoo.api.Response) searchObject(objectName, filter, -1, -1, null, false);
    }
     ...
     *         successfull
     */
    public com.dispatcher.service.odoo.api.Response searchObject(String objectName, Object[] filter, int offset, int limit, String order, boolean count)
        ...
        try {
            ...
            com.dispatcher.service.odoo.api.Response response = (this.session.getServerVersion().getMajor() < 10)
                    ? new com.dispatcher.service.odoo.api.Response(session.executeCommand(objectName, "search", params))
                    : new com.dispatcher.service.odoo.api.Response(session.executeCommandWithContext(objectName, "search", params));

            return response;
        } catch (XmlRpcException e) {
            return new com.dispatcher.service.odoo.api.Response(e);
        }
    }
     ...
     */
    public com.dispatcher.service.odoo.api.Response callObjectFunction(String objectName, String functionName, Object[] parameters) {
        try {
            return new com.dispatcher.service.odoo.api.Response(session.executeCommand(objectName, functionName, parameters));
        } catch (XmlRpcException e) {
            return new com.dispatcher.service.odoo.api.Response(e);
        }
    }
